...
| G | `docs/pipeline.md` and `docs/build-source-map.md` reference "kino" as a source project (provenance notes) | Not secret, describes where logic was ported from | Keep as internal history, or scrub if this repo's visibility changes? |
